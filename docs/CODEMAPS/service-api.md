...
| `routes/workspace.py` | 344 | Workspace, capabilities, module report, reset | `capabilities` (registered targets) and `modules` (configured modules) must agree; they once disagreed about Shopify. |
